...
const messages = {
  en: {
    ...
    localDescription: "Start the self-contained single-Node Launcher. StarAgent and its native terminal backend are included.",
    runtime: "Runtime",
    checking: "Checking local runtime…",
    strategy: "Strategy",
    runtimeMissing: "The bundled runtime is unavailable. Reinstall this desktop package.",
  ...
  zh: {
    ...
    localMode: "本机模式",
    localTitle: "当前机器",
    localDescription: "启动开箱即用的单 Node Launcher；StarAgent 与原生终端后端均已内置。",
    runtime: "运行环境",
    checking: "正在检测本机运行环境…",
    strategy: "启动方式",
    runtimeMissing: "安装包内的运行时不可用，请重新安装桌面版。",
    copyCommand: "复制命令",
    copied: "已复制",
